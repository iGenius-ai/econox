      ...
      >
        ...
        <div className="container mx-auto flex justify-between items-center">
          <Link href="/" className={`text-2xl font-bold ${isScrolled ? "text-white" : "text-gray-100"} flex items-center`}>
            <Image src={"/metadroid-fav.png"} alt='Brand Logo' width={60} height={60} objectFit='center' />
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed top-0 right-0 bottom-0 w-72 bg-gray-900 shadow-lg z-50 md:hidden overflow-y-auto"
          >
            <div className="p-4">
