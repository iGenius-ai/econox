    ...
    >
      <div className="relative z-10 flex flex-col gap-y-6 justify-center text-center sm:text-left sm:mb-4 max-sm:items-center">
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-7xl max-w-3xl text-gray-50 font-bold"
        >
          Earn, Stake and Burn with Econox: <span className="text-[#14919B]">Join the Movement</span> 
        </motion.h1>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4'>
          ...
          <motion.ul variants={textVariant(1.5)} className="flex items-center flex-wrap gap-2">
            ...
            <li className='bg-[#131327] text-white text-sm transitional duration-200 ease-in-out hover:bg-[#0b6477] p-3 px-4 rounded-full'>
