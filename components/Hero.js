...
const Hero = () => (
  <section className={``}>
    <motion.div
      ...
      className={`flex flex-col sm:flex-row items-center mx-auto`}
    >
      <div className="relative z-10 flex flex-col gap-y-6 justify-center text-center sm:text-left sm:mb-4 max-sm:items-center">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl md:text-8xl text-white font-bold"
        >
          EconoxCoin
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-base sm:text-lg md:text-xl text-[#f7f7f7]"
        >
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4'>
          <motion.div variants={textVariant(1.4)} className='flex items-center'>
            <Link href={"/"} className='flex items-center gap-x-2 text-white bg-[#e836d1] p-3 px-4 rounded-full'>
            ...
            <Link href={"/another"} className='flex items-center gap-x-2 text-white bg-[#e836d1] p-2 rounded-full'>
          ...
          <motion.ul variants={textVariant(1.5)} className="flex items-center flex-wrap gap-2">
            <li className='bg-[#131327] text-white text-sm transitional duration-200 ease-in-out hover:bg-[#E836D1] p-3 rounded-full'>
            ...
            <li className='bg-[#131327] text-white text-sm transitional duration-200 ease-in-out hover:bg-[#E836D1] p-3 px-4 rounded-full'>
