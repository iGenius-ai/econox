    ...
    >
      <div className="relative z-10 flex flex-col gap-y-6 justify-center text-center sm:text-left sm:mb-4 max-sm:items-center">
        <motion.p
          ...
          className="uppercase banner-text font-semibold w-max text-xs sm:text-base relative"
        >
          3rd Generation Decentralized Technology
        </motion.p>

        <motion.h1
          variants={textVariant(1.1)}
          className="text-4xl sm:text-6xl md:text-8xl text-[#0AD1C8] font-bold"
        >
          EconoxCoin
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-base sm:text-lg md:text-xl max-w-3xl text-[#80ED99]"
        >
          Buy EconoxCoin Now and be a part of the first and fastest 3rd Generation Decentralized Blockchain & FinTech Ecosystem
        </motion.p>

        <div className='flex flex-col sm:flex-row items-center gap-4'>
          <motion.div variants={textVariant(1.4)} className='flex items-center'>
            <Link href={"/"} className='flex items-center gap-x-2 text-white border-[#14919B] transition-all duration-300 ease-in-out border bg-[#14919B] hover:text-[#14919B] hover:bg-transparent p-3 px-4 rounded-full'>
            ...
            <Link href={"/another"} className='flex items-center gap-x-2 text-white border-[#14919B] bg-[#14919B] transition-all duration-300 ease-in-out border hover:text-[#14919B] hover:bg-transparent p-2 rounded-full'>
          ...
          <motion.ul variants={textVariant(1.5)} className="flex items-center flex-wrap gap-2">
            <li className='bg-[#131327] text-white text-sm transitional duration-200 ease-in-out hover:bg-[#14919B] p-3 rounded-full'>
              <a className="d-flex items-center justify-content-center rounded-pill" title="Twitter" href="https://twitter.com/AitikChain" target="_blank">
                <svg className="custom-svg" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className='bg-[#131327] text-white text-sm transitional duration-200 ease-in-out hover:bg-[#14919B] p-3 rounded-full'>
              <a className="d-flex items-center justify-content-center rounded-pill" title="Telegram Group" href="https://t.me/AitikChain" target="_blank">
                <svg className="custom-svg" width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className='bg-[#131327] text-white text-sm transitional duration-200 ease-in-out hover:bg-[#14919B] p-3 px-4 rounded-full'>
              <a className="d-flex items-center justify-content-center rounded-pill" title="Link Tree" href="https://linktr.ee/aitikchain" target="_blank">
                <svg className="custom-svg" width="20" height="25" viewBox="0 0 20 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className='bg-[#131327] text-white text-sm transitional duration-200 ease-in-out hover:bg-[#14919B] p-3 rounded-full'>
              <a className="d-flex items-center justify-content-center rounded-pill" title="Github" href="https://github.com/AitikChain" target="_blank">
                <svg className="custom-svg" width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
