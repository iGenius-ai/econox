...
const Hero = () => (
  <section className={``}>
    <div className={`flex flex-col sm:flex-row justify-center items-center container py-28 mx-auto`}>
      <div className="relative z-10 flex flex-col gap-y-4 md:gap-y-6 justify-center text-center sm:text-left sm:mb-4 max-sm:items-center">
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4'>
          <div className='flex items-center'>
            <Link href={"/roadmap"} className='flex items-center gap-x-2 text-white border-[#0b6477] transition-all duration-300 ease-in-out border bg-[#0b6477] hover:text-[#14919B] hover:bg-transparent p-3 px-4 rounded-lg'>
          ...
          <ul className="flex items-center flex-wrap gap-2">
            <li className='bg-[#131327] text-white text-sm transitional duration-200 ease-in-out hover:bg-[#0b6477] p-3 rounded-lg'>
              <a className="d-flex items-center justify-content-center text-xs rounded-pill" title="Twitter" href="https://x.com/econoxsol" target="_blank">
            ...
            <li className='bg-[#131327] text-white text-sm transitional duration-200 ease-in-out hover:bg-[#0b6477] p-3 rounded-lg'>
              <a className="d-flex items-center justify-content-center rounded-pill" title="Telegram Community" href="https://t.me/+lEDNNkJNHqw0MDA0" target="_blank">
      ...
      <div className='relative z-0 sm:pl-6 pl-0 mt-6 sm:mt-0 max-w-2xl flex items-center'>
        <PresaleDashboard />
      </div>
    </div>
  </section>
